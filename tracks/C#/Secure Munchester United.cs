...
{
    public string GetDisplayName(TeamSupport support) => support.Title switch
    {
        "The Manager" => "Too Important for a Security Pass",
        "Security Team Member" => $"{support.Title} Priority Personnel",
        _ => support.Title
    };
}
